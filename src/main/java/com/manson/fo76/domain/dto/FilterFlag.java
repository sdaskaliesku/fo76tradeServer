...
public enum FilterFlag {
  ...
  ARMOR("Armor", true, new ArrayList<>(), RawFilterFlags.FILTER_ARMOR),
  ...
  public static FilterFlag fromString(String flag) {
    ...
    return Arrays.stream(values())
        .filter(filterFlag -> StringUtils.equalsIgnoreCase(flag, filterFlag.value)).findFirst().orElse(UNKNOWN);
  }
